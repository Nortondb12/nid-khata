...
const NidResult = ({ data }: NidResultProps) => {
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="relative p-[2px] rounded-[26px] bg-gradient-to-br from-emerald-500 via-teal-500 to-cyan-600 shadow-2xl shadow-emerald-900/20 animate-gradient-x">
        <div className="absolute inset-0 rounded-[26px] bg-gradient-to-br from-emerald-500/20 via-teal-500/10 to-cyan-600/20 blur-xl" aria-hidden="true" />
        ...
        >
          ...
          <div className="relative bg-gradient-to-r from-emerald-800 via-teal-800 to-emerald-900 px-6 py-6 text-white overflow-hidden">
            {/* Decorative pattern */}
            ...
            <div className="absolute right-14 -bottom-6 opacity-10 select-none" aria-hidden="true">
            ...
            <div className="relative flex items-start justify-between gap-3">
              <div className="flex items-start gap-3.5">
                <div className="relative">
                  <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-white/15 backdrop-blur-xl ring-1 ring-white/30 shadow-inner">
                    <ShieldCheck className="h-6 w-6 text-white" />
                  </div>
                  <div className="absolute -bottom-1 -right-1 h-3.5 w-3.5 rounded-full bg-teal-400 ring-2 ring-emerald-900" />
                </div>
                
                <div className="space-y-1.5">
                  <span className="inline-flex items-center gap-1.5 rounded-full bg-white/10 px-3 py-1 text-[10px] font-semibold uppercase tracking-wider text-emerald-100 ring-1 ring-white/20 backdrop-blur-md">
                    <CheckCircle2 className="h-3.5 w-3.5 text-teal-300" /> 
                    যাচাইকৃত সার্ভার রেকর্ড
                  </span>
                  <h3 className="text-lg sm:text-xl font-bold leading-tight tracking-tight text-white drop-shadow-md">
              ...
              <div className="hidden sm:flex flex-col items-end gap-2">
                ...
                <div className="rounded-full border border-white/10 bg-black/20 px-3 py-1 text-editor">
          ...
          {/* Content */}
          <CardContent className="p-5 sm:p-7 space-y-6 bg-card">
            {/* Profile Grid */}
                ...
                {data.photo ? (
                  <>
                    <img
                      ...
                      className="relative w-28 h-32 sm:w-32 sm:h-36 object-cover rounded-2xl border-2 border-white shadow-lg ring-4 ring-emerald-900/10"
                    />
                    <div className="absolute inset-0 rounded-2xl bg-gradient-to-t from-emerald-900/20 via-transparent to-transparent" />
                    <div className="absolute -bottom-2 left-1/2 -translate-x-1/2 bg-emerald-600 text-white px-2.5 py-0.5 rounded-full shadow-lg flex items-center gap-1 text-[9px] font-semibold uppercase tracking-wider">
                      <CheckCircle2 className="w-3 h-3" />
                      যাচাইকৃত
                    </div>
                  </>
                ) : (
                  <div className="relative w-28 h-32 sm:w-32 sm:h-36 rounded-2xl border-2 border-dashed border-emerald-500/50 bg-gradient-to-br from-muted to-emerald-500/10 flex flex-col items-center justify-center shadow-inner">
              ...
              <div className="flex-1 w-full space-y-3.5">
                <div className="space-y-1.5">
                  ...
                  <div>
                    ...
                    <p lang="en" className="text-sm sm:text-base font-semibold text-muted-foreground font-mono tracking-wider mt-0.5">
                      {name_en}
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-wrap gap-2">
                  <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-xl bg-emerald-500/10 border border-emerald-500/25 text-emerald-700 dark:text-emerald-300 shadow-sm">
            ...
            <div className="relative overflow-hidden rounded-2xl border border-emerald-500/15 bg-gradient-to-r from-emerald-500/5 via-teal-500/5 to-cyan-500/5">
              <div className="flex items-center justify-center gap-3 py-2 px-4 opacity-40 text-muted-foreground pointer-events-none select-none" aria-hidden="true">
                ...
                <span className="text-xs font-bold uppercase tracking-[0.35em] whitespace-nowrap">
            ...
            <dl className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {fieldData.map((field) => (
                <div 
                  key={field.label}
                  className={`group relative overflow-hidden p-4 rounded-2xl bg-gradient-to-br ${field.accent} border shadow-sm transition-all duration-300 hover:shadow-lg hover:scale-[1.01] ${field.label === "ঠিকানা" ? "sm:col-span-2" : ""}`}
                >
                  ...
                  <div className="relative flex items-start gap-3">
                    <div className={`flex items-center justify-center w-9 h-9 rounded-xl bg-white/50 dark:bg-white/10 border border-border/50 shadow-sm transition-transform duration-300 group-hover:scale-110`}>
                      {field.icon}
                    </div>
                    <div className="flex-1 min-w-0">
                      ...
                      <dd className="text-sm font-semibold text-primary leading-snug break-words max-w-[240px] sm:max-w-none">
                        {field.value}
                      </dd>
                    </div>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-3 pt-2">
              ...
              <Button
                ...
                className="text-xs text-muted-foreground hover:text-foreground hover:bg-emerald-500/10 h-9 gap-2 rounded-xl px-4"
              >
                {copied ? (
                  <>
                  ...
                  <>
                    <Share2 className="w-4 h-4 text-teal-600 dark:text-teal-400" aria-hidden="true" />
      ...
      {downloadError && (
        <div
          role="alert"
          className="no-print flex items-start gap-3 text-destructive text-sm bg-destructive/10 border border-destructive/25 p-5 rounded-2xl shadow-lg backdrop-blur-sm animate-in slide-in-from-top-2 duration-300"
        >
          ...
          <div className="space-y-1">
            ...
            <p className="text-destructive/90">{downloadError}</p>
          </div>
        </div>
      )}
      ...
      {progress && (
        <div
          role="status"
          aria-live="polite"
          className="no-print rounded-2xl border border-emerald-500/30 bg-gradient-to-r from-emerald-500/5 via-teal-500/5 to-cyan-500/5 p-5 space-y-4 shadow-lg backdrop-blur-sm animate-in slide-in-from-top-2 duration-300"
        >
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <div className="flex items-center justify-between mb-1">
                ...
                <Badge variant="secondary" className="font-mono text-xs tabular-nums rounded-lg">
      ...
      {provenance && (
        <div
          role="status"
          aria-live="polite"
          className="no-print rounded-2xl border border-emerald-500/25 bg-gradient-to-r from-emerald-50/80 to-teal-50/50 dark:from-emerald-950/20 dark:to-teal-950/10 p-5 backdrop-blur-sm animate-in slide-in-from-top-2 duration-300 shadow-lg"
        >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-xs">
            <div className="flex items-center justify-between p-3 rounded-xl bg-background/70 border border-border/50">
              <span className="text-muted-foreground">সার্ভারে তৈরি:</span>
              <span className="font-semibold text-foreground">{provenance.issuedAt}</span>
            </div>
            <div className="flex items-center justify-between p-3 rounded-xl bg-background/70 border border-border/50">
      ...
      {/* Action Buttons */}
      <div className="no-print grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
        <Button
          onClick={() => handleDownload("pdf")}
          disabled={busy !== null}
          size="lg"
          className="relative h-13 py-3.5 bg-gradient-to-r from-emerald-600 to-teal-600 hover:from-emerald-700 hover:to-teal-700 text-white font-bold rounded-2xl shadow-xl shadow-emerald-600/30 transition-all active:scale-[0.98] hover:shadow-2xl hover:shadow-emerald-600/40 group overflow-hidden"
        ...
        <Button
          ...
          variant="outline"
          size="lg"
          className="h-13 py-3.5 font-bold rounded-2xl bg-gradient-to-r from-emerald-600/5 to-teal-600/5 hover:from-emerald-500/15 hover:to-teal-500/15 border-emerald-600/30 hover:border-emerald-600/50 text-foreground transition-all active:scale-[0.98] box-glow"
          aria-label="সার্ভার কপি ছবি হিসেবে ডাউনলোড করুন"
        >
          {busy === "png" ? (
            <>
              <Loader2 className="w-5 h-5 mr-2 animate-spin text-emerald-600 dark:text-emerald-400" aria-hidden="true" />
              <span>তৈরি হচ্ছে...</span>
            </>
          ) : (
            <>
              <FileImage className="w-5 h-5 mr-2 text-emerald-600 dark:text-emerald-400" aria-hidden="true" />
              <span>ছবি (PNG) ডাউনলোড করুন</span>
            </>
          )}
        </Button>
      </div>
